...
<head>
  ...
  <style>
    ...
    * {
    ...
    .layout.collapsed .nav .navDisabled {
    ...
    th {
      font-weight: 900;
      color: #555;
      background: rgba(177, 143, 110, .10);
    }
    ...
    .tag.subah {
      background: var(--subah);
      border-color: var(--subah);
      color: #fff;
    }

    .tag.asr {
      background: var(--asr);
      border-color: var(--asr);
      color: #fff;
    }
    ...
    .btnMini:hover {
      background: rgba(62, 132, 106, .08);
      border-color: rgba(62, 132, 106, .25);
    }
            ...
            <table>
              ...
              <tbody>
                <?php if (empty($students_active)): ?>
                  <tr>
                    <td colspan="6" style="color:#777; padding:14px;"><?php echo h($tr['no_students']); ?></td>
                  </tr>
                <?php else: ?>
            ...
            <table>
              ...
              <tbody>
                <?php if (empty($students_removed)): ?>
                  <tr>
                    <td colspan="6" style="color:#777; padding:14px;"><?php echo $lang === 'ur' ? 'ابھی تک کوئی ریکارڈ نہیں' : 'No records yet'; ?></td>
                  </tr>
                <?php else: ?>
